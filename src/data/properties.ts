...
export const projects: Project[] = [
  {
    ...
    status: "Now Selling",
    description: "Naples Estate is a thoughtfully planned residential community in Arepo, one of the fastest-growing satellite towns along the Lagos–Ibadan Expressway. Our location puts you right in the company of some of the most respected estates in the area, with easy access to major landmarks like Punch Place, Channels TV, and Mikano.\n\nWe created Naples Estate for people who want peace without losing connection—serene surroundings, solid neighborhood value, and smooth access to Lagos and beyond. It’s not just where you live; it’s where your investment grows and your everyday life feels easier. Quiet. Strategic. Well-positioned.",
    amenities: [
      "Recreational Centre",
      "24/7 Security",
      "Paved Roads",
    ...
    paymentPlans: [
      {
        ...
        monthlyPayment: "Spread balance within 3 months",
      },
      {
        name: "Short Term (5% Interest)",
        duration: "6 months",
        initialDeposit: "₦30,000,000",
        monthlyPayment: "Spread balance within 6 months",
      },
      {
        name: "Long Term (10% Interest)",
        duration: "12 months",
        initialDeposit: "₦30,000,000",
        monthlyPayment: "Balance can be spread up to 12 months",
      },
    ],
    coordinates: { lat: 6.7074, lng: 3.4416 },
