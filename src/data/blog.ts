...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: `
      ...
      <p>Consider investing in our Naples Arepo or The Novara Courts estates, which offer land plots starting from 300sqm with guaranteed titles and comprehensive facility management services.</p>
    `,
  ...
  },
  {
    ...
    content: `
      ...
      <p>All our properties come with proper documentation. The Naples Arepo is covered by a Certificate of Occupancy, while The Novara Courts is covered by a registered survey (OG/0765/2023/067), ensuring your investment is secure.</p>
    `,
  ...
  },
  {
    ...
    content: `
      ...
      <p>Our estates at Naples Arepo and The Novara Courts are designed with all these benefits in mind, providing you with a premium living experience at affordable prices.</p>
    `,
